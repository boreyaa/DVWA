...
```
效果图https://github.com/boreyaa/DVWA/blob/main/XSS(DOM)/xss-low.png
关键：#后面的内容不会发送给服务器
...
<svg onload=alert(1)>
```
效果图https://github.com/boreyaa/DVWA/blob/main/XSS(DOM)/xss-medium.png
## medium建议手动进行的实操过程
...
效果图https://github.com/boreyaa/DVWA/blob/main/XSS(DOM)/xss-high.png
